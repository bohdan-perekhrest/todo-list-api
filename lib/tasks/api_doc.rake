namespace :dox do
  ...
  task :json, [:version, :docs_path, :host] => :environment do |_, args|
    ...
    RSpec::Core::RakeTask.new(:api_spec) do |t|
      ...
      t.rspec_opts =
        "-f Dox::Formatter --tag dox --order defined --out public/api/#{version}/docs/apispec.json"
    end
  ...
  task :html, [:version, :docs_path, :host] => :json do |_, args|
    ...
    `yarn run redoc-cli bundle -o public/#{docs_path}/index.html public/api/docs/#{version}/apispec.json`
  end
